export const metadata = { title: 'Privacy — Earshot' };
  ...
  return (
    <div className="shell">
      ...
      <article className="prose">
        ...
        <div className="date">Last updated 1 September 2026</div>
      ...
      <footer>
        <a href="/">← Back</a>
        <span className="sp">Earshot runs entirely on your machine.</span>
      </footer>
    </div>
  );
}
